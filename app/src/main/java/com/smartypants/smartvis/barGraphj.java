...
//
//class BarChartActivity extends AppCompatActivity {
//
//    void createBarGraph(String name,AnyChartView anyChartView) {
//
...
////
////        barChart.setYScale().stackMode(ScaleStackMode.VALUE);
////
...
////        barChart.setLegend().padding(0d, 0d, 20d, 0d);
//
