...
class tagCloud() {
    fun createTagCloud(name: String, anyChartView : AnyChartView)
    {
        ...
        val ordinalColor : OrdinalColor = OrdinalColor()
        ordinalColor.setColors(arrayOf("#26959f", "#f18126", "#3b8ad8", "#60727b", "#e24b26"))
        tagCloud.setColorScale(ordinalColor)
        tagCloud.setAngles(arrayOf(-90.0, 0.0, 90.0))

        tagCloud.setColorRange(true)
        tagCloud.setColorRange("15.0")
